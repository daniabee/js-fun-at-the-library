...
if (pages < 1000) {
  ...
  console.log("Okay, maybe I could read that in a day and half."); }
...
console.log('3rd Element of Books', books[2]);

// Create a new variable "belowTwoHundred" and assign it to an Array of 12
// different numbers below two hundred.

var belowTwoHundred = [23, 45, 55, 166, 177, 150, 1, 87, 93, 12, 199, 44];

// Write the code to access the 5th element of the array, using bracket notation.

console.log('5th Element of Books', belowTwoHundred[4]);
